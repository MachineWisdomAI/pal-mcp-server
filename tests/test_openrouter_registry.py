...
class TestOpenRouterModelRegistry:
    ...
    def test_alias_resolution(self):
        ...
        test_cases = [
            ...
            ("opus4.5", "anthropic/claude-opus-4.5"),  # Version-specific still works
            ("opus4.1", "anthropic/claude-opus-4.1"),  # 4.1 still accessible
            ("sonnet", "anthropic/claude-sonnet-4.6"),  # sonnet now points to 4.6
            ("sonnet4.6", "anthropic/claude-sonnet-4.6"),
            ("sonnet4.5", "anthropic/claude-sonnet-4.5"),  # Version-specific still works
            ("pro", "google/gemini-3.1-pro-preview"),  # pro now points to 3.1
            ("gemini3.1", "google/gemini-3.1-pro-preview"),
            ("gemini3.0", "google/gemini-3-pro-preview"),  # Version-specific still works
            ("o3", "openai/o3"),
